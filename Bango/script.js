...
function maxFive(array, container) {
    for(let rowNum = 2; rowNum >= 0; rowNum--) { //looper 3 gange, for hver row i pladen
        array.sort(function(a, b) {return b.length - a.length}); //sorter arrays fra største til mindste inden de sættes på plads, så dem med 3 kommer først.. hvis vi fjerner, el halvdelen ikke med
